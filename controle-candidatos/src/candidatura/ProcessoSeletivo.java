...
public class ProcessoSeletivo {
    ...
    static boolean atender(){//método auxiliar
        return new Random().nextInt(3)==1;
    }

    static void imprimirSelecionados(){//case 3
        String[] candidatos = {"FELIPE", "MARCIA", "JULIA", "PAULO", "AUGUSTO"};
    ...
    static void selecaoCandidatos(){//case 2
    ...
    static double valorPretendido(){//case 2 - simula o valor pretendido
        return ThreadLocalRandom.current().nextDouble(1800, 2200);
    }

    static void analisarCandidato(double salarioPretendido){ //case 1
        double salarioBase = 2000.0;
        if(salarioBase > salarioPretendido){
